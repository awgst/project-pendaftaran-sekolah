...
<div class="header">
  ...
  <div class="isi">
    <div class="container">
        <h2>PSB2018</h2 >
        <p>Selamat Datang di Web Penerimaan Siswa Baru 2018</p>
      <div class="row">
        <div class="col-lg-3">
          <form action="form.php">
          <h4>Pendaftaran</h4>
          <p>Untuk Mendaftar Silahkan Klik Tombol di Bawah</p>
          <input type="submit" class="btn btn-primary" value="Daftar">
          </form>
        </div>
        <div class="col-lg-3">
        <h4>Daftar Pendaftar</h4>
        <p>Lihat Pendaftar</p><br><form action="tampil_data.php" method="post">
        ...
        <div class="col-lg-3">
        <h4>Info</h4>
        <p>Informasi Selengkapnya</p><br><form action="alur.php" method="post">
        <input type="submit" class="btn btn-primary" value="Lihat">
        </form>
        </div>
        <div class="col-lg-3">
          <h4>Profil Sekolah</h4>
          <p>Informasi Sekolah</p><br><form action="profil_sekolah.php" method="post">
          <input type="submit" class="btn btn-primary" value="Lihat">
          </form>
        </div>
      </div>
