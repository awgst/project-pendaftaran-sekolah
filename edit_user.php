    ...
    <div class="container">
      <div class="col-lg-3">
         ...
         <div class="col-lg-9">
          ...
          <table>
    		<tr>
    			<td colspan="2"><form method="POST" action="proses_input_form.php">
			  <div class="form-group">
			    <label for="no">Nomor Pendaftaran:</label>
			    <input type="text" class="form-control" disabled="disabled" value="<?=$data['id']?>">
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <br>
			    <input type="radio" name="jk" value="Laki-laki" checked="<?php if($data['jenis_kelamin']=="Laki-laki"){echo "checked"; } ?>">Laki-laki
			     <input type="radio"  name="jk" value="Perempuan" checked="<?php if($data['jenis_kelamin']=="Perempuan"){echo "checked"; } ?>">Perempuan
			  </div>	
			  <div class="form-group">
